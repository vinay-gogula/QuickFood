...
<b> YOUR ORDER HAS SUCCESSFULLY BEEN DELIVERED </b>
<br> Thank You For Using QuickFood </br>
<div style="text-align: right"><a href="<%=request.getContextPath()%>/LogoutServlet" class="w3-button w3-teal" >Logout</a></div>
<div style="text-align: center"><a href="index.jsp" class="w3-btn w3-teal w3-round-xxlarge w3-large" >Go Back To Home</a></div>
</div>
